...
table05 = ["my Trust.", "my field.", "my department.", "my practice.", "my work.", "my daily activities.", "my specialty.", "my team.", "my group.", "our unit.", "my discipline.", "our current approach.", "our new hospital."]
...
print("Here is an aid, so diverse there are {} permutations!".format(permutations))
print("\n")
